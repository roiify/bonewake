...
export const ENEMY_TEMPLATES = {
  ...
  bloated_glutton:  { name: 'Bloated Glutton',  element: 'dark' as const,  archetype: 'tank'    as const, baseStats: { hp: 6200, atk: 230, def: 220, spd: 35,  crit: 0.10 }, color: '#65a30d', ultimateId: 'enemy_basic' },
  ...
  conjoined_horror: { name: 'Conjoined Horror', element: 'dark' as const,  archetype: 'warrior' as const, baseStats: { hp: 4800, atk: 310, def: 150, spd: 55,  crit: 0.18 }, color: '#7c2d12', ultimateId: 'enemy_basic' },
  stitched_brute:   { name: 'Stitched Brute',   element: 'dark' as const,  archetype: 'warrior' as const, baseStats: { hp: 5400, atk: 340, def: 160, spd: 50,  crit: 0.15 }, color: '#78350f', ultimateId: 'enemy_basic' },
  drowned_lurker:   { name: 'Drowned Lurker',   element: 'dark' as const,  archetype: 'assassin' as const,baseStats: { hp: 3000, atk: 360, def: 80,  spd: 105, crit: 0.30 }, color: '#0891b2', ultimateId: 'enemy_basic' },
  acid_vomiter:     { name: 'Acid Vomiter',     element: 'dark' as const,  archetype: 'mage'    as const, baseStats: { hp: 3600, atk: 330, def: 110, spd: 70,  crit: 0.18 }, color: '#84cc16', ultimateId: 'enemy_basic' },
  plague_bride:     { name: 'Plague Bride',     element: 'dark' as const,  archetype: 'mage'    as const, baseStats: { hp: 4000, atk: 340, def: 115, spd: 75,  crit: 0.20 }, color: '#a3e635', ultimateId: 'enemy_basic' },
  ...
  maggot_host:      { name: 'Maggot Host',      element: 'dark' as const,  archetype: 'mage'    as const, baseStats: { hp: 3400, atk: 320, def: 105, spd: 65,  crit: 0.18 }, color: '#a16207', ultimateId: 'enemy_basic' },
  butcher_zombie:   { name: 'Butcher Zombie',   element: 'dark' as const,  archetype: 'warrior' as const, baseStats: { hp: 4400, atk: 320, def: 145, spd: 60,  crit: 0.20 }, color: '#991b1b', ultimateId: 'enemy_basic' },
  crypt_wyvern:     { name: 'Crypt Wyvern',     element: 'dark' as const,  archetype: 'warrior' as const, baseStats: { hp: 4800, atk: 420, def: 130, spd: 100, crit: 0.28 }, color: '#581c87', ultimateId: 'enemy_basic' },
  obsidian_knight:  { name: 'Obsidian Knight',  element: 'dark' as const,  archetype: 'tank'    as const, baseStats: { hp: 5800, atk: 340, def: 200, spd: 65,  crit: 0.18 }, color: '#1f2937', ultimateId: 'enemy_basic' },
};
