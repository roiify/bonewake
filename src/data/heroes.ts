...
export const ENEMY_SPRITES: Record<string, {
  ...
  shambler:      { idle: A('sprites/echoes/enemies/shambler_idle.png'),      attack: A('sprites/echoes/enemies/shambler_attack.png'), skill: A('sprites/echoes/enemies/shambler_idle.png'), hit: A('sprites/echoes/enemies/shambler_idle.png'), death: A('sprites/echoes/enemies/shambler_idle.png'),      cols: 9, rows: 1 },
