...
export const ENEMY_SPRITES: Record<string, {
  ...
  astral_archer: { idle: A('sprites/pixellab/enemies/pro/astral_archer_idle.png'), attack: A('sprites/pixellab/enemies/pro/astral_archer_west.png'), skill: A('sprites/pixellab/enemies/pro/astral_archer_west.png'), hit: A('sprites/pixellab/enemies/pro/astral_archer_west.png'), death: A('sprites/pixellab/enemies/pro/astral_archer_west.png'), portrait: A('sprites/pixellab/enemies/pro/astral_archer_south.png'), cols: 1, rows: 1, idleCols: 4 },
