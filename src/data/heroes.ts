...
export const HERO_SPRITES: Record<string, {
  ...
  luna:   { idle: A('sprites/pixellab/heroes/luna_idle.png'), attack: A('sprites/pixellab/heroes/luna_attack.png'), skill: A('sprites/pixellab/heroes/luna_skill.png'), hit: A('sprites/pixellab/heroes/luna_idle.png'), death: A('sprites/pixellab/heroes/luna_death.png'), cols: 43, rows: 1 },
  elara:  { idle: A('sprites/pixellab/heroes/elara_idle.png'),  attack: A('sprites/pixellab/heroes/elara_attack.png'),  skill: A('sprites/pixellab/heroes/elara_skill.png'),  hit: A('sprites/pixellab/heroes/elara_idle.png'),  death: A('sprites/pixellab/heroes/elara_death.png'),  cols: 43, rows: 1 },
  aelia:  { idle: A('sprites/pixellab/heroes/aelia_idle.png'),  attack: A('sprites/pixellab/heroes/aelia_attack.png'),  skill: A('sprites/pixellab/heroes/aelia_skill.png'),  hit: A('sprites/pixellab/heroes/aelia_idle.png'),  death: A('sprites/pixellab/heroes/aelia_death.png'),  cols: 43, rows: 1 },
  kengo:  { idle: A('sprites/pixellab/heroes/kengo_idle.png'),  attack: A('sprites/pixellab/heroes/kengo_attack.png'),  skill: A('sprites/pixellab/heroes/kengo_skill.png'),  hit: A('sprites/pixellab/heroes/kengo_idle.png'),  death: A('sprites/pixellab/heroes/kengo_death.png'),  cols: 43, rows: 1 },
  len:    { idle: A('sprites/pixellab/heroes/len_idle.png'),    attack: A('sprites/pixellab/heroes/len_attack.png'),    skill: A('sprites/pixellab/heroes/len_skill.png'),    hit: A('sprites/pixellab/heroes/len_idle.png'),    death: A('sprites/pixellab/heroes/len_death.png'),    cols: 43, rows: 1 },
  kaius:  { idle: A('sprites/pixellab/heroes/kaius_idle.png'),  attack: A('sprites/pixellab/heroes/kaius_attack.png'),  skill: A('sprites/pixellab/heroes/kaius_skill.png'),  hit: A('sprites/pixellab/heroes/kaius_idle.png'),  death: A('sprites/pixellab/heroes/kaius_death.png'),  cols: 43, rows: 1 },
  pyra:   { idle: A('sprites/pixellab/heroes/pyra_idle.png'),   attack: A('sprites/pixellab/heroes/pyra_attack.png'),   skill: A('sprites/pixellab/heroes/pyra_skill.png'),   hit: A('sprites/pixellab/heroes/pyra_idle.png'),   death: A('sprites/pixellab/heroes/pyra_death.png'),   cols: 43, rows: 1 },
  korvan: { idle: A('sprites/pixellab/heroes/korvan_idle.png'), attack: A('sprites/pixellab/heroes/korvan_attack.png'), skill: A('sprites/pixellab/heroes/korvan_skill.png'), hit: A('sprites/pixellab/heroes/korvan_idle.png'), death: A('sprites/pixellab/heroes/korvan_death.png'), cols: 43, rows: 1 },
};
