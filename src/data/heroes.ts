...
export const ENEMY_SPRITES: Record<string, {
  ...
  crimson_centaur:  { idle: A('sprites/bosses/crimson_centaur_idle.png'), attack: A("sprites/bosses/crimson_centaur_attack.png"), skill: A("sprites/bosses/crimson_centaur_attack.png"), hit: A("sprites/bosses/crimson_centaur_idle.png"), death: A("sprites/bosses/crimson_centaur_idle.png"), portrait: A("sprites/bosses/crimson_centaur_idle.png"), cols: 1, rows: 1, attackCols: 9 },
  lich_king:        { idle: A('sprites/bosses/lich_king_idle.png'), attack: A("sprites/bosses/lich_king_attack.png"), skill: A("sprites/bosses/lich_king_attack.png"), hit: A("sprites/bosses/lich_king_idle.png"), death: A("sprites/bosses/lich_king_idle.png"), portrait: A("sprites/bosses/lich_king_idle.png"), cols: 1, rows: 1, attackCols: 9 },
  bone_titan:       { idle: A('sprites/bosses/bone_titan_idle.png'), attack: A("sprites/bosses/bone_titan_attack.png"), skill: A("sprites/bosses/bone_titan_attack.png"), hit: A("sprites/bosses/bone_titan_idle.png"), death: A("sprites/bosses/bone_titan_idle.png"), portrait: A("sprites/bosses/bone_titan_idle.png"), cols: 1, rows: 1, attackCols: 9 },
  plague_doctor:    { idle: A('sprites/bosses/plague_doctor_idle.png'), attack: A("sprites/bosses/plague_doctor_attack.png"), skill: A("sprites/bosses/plague_doctor_attack.png"), hit: A("sprites/bosses/plague_doctor_idle.png"), death: A("sprites/bosses/plague_doctor_idle.png"), portrait: A("sprites/bosses/plague_doctor_idle.png"), cols: 1, rows: 1, attackCols: 9 },
  ash_empress:      { idle: A('sprites/bosses/ash_empress_idle.png'), attack: A("sprites/bosses/ash_empress_attack.png"), skill: A("sprites/bosses/ash_empress_attack.png"), hit: A("sprites/bosses/ash_empress_idle.png"), death: A("sprites/bosses/ash_empress_idle.png"), portrait: A("sprites/bosses/ash_empress_idle.png"), cols: 1, rows: 1, attackCols: 9 },
  soul_reaper:      { idle: A('sprites/bosses/soul_reaper_idle.png'), attack: A("sprites/bosses/soul_reaper_attack.png"), skill: A("sprites/bosses/soul_reaper_attack.png"), hit: A("sprites/bosses/soul_reaper_idle.png"), death: A("sprites/bosses/soul_reaper_idle.png"), portrait: A("sprites/bosses/soul_reaper_idle.png"), cols: 1, rows: 1, attackCols: 9 },
  voidlord:         { idle: A('sprites/bosses/voidlord_idle.png'), attack: A("sprites/bosses/voidlord_attack.png"), skill: A("sprites/bosses/voidlord_attack.png"), hit: A("sprites/bosses/voidlord_idle.png"), death: A("sprites/bosses/voidlord_idle.png"), portrait: A("sprites/bosses/voidlord_idle.png"), cols: 1, rows: 1, attackCols: 9 },
  worm_god:         { idle: A('sprites/bosses/worm_god_idle.png'), attack: A("sprites/bosses/worm_god_attack.png"), skill: A("sprites/bosses/worm_god_attack.png"), hit: A("sprites/bosses/worm_god_idle.png"), death: A("sprites/bosses/worm_god_idle.png"), portrait: A("sprites/bosses/worm_god_idle.png"), cols: 1, rows: 1, attackCols: 9 },
};
