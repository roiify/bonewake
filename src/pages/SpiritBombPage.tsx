...
import { ENEMY_SPRITES, HERO_BY_ID, HERO_SPRITES } from '../data/heroes';
      ...
      <div className="rounded-lg border-2 border-rose-700 bg-gradient-to-b from-rose-950/40 to-zinc-900 p-4">
        <div className="flex items-center gap-3">
          {ENEMY_SPRITES[boss.templateId as keyof typeof ENEMY_SPRITES] ? (
            <StaticSprite src={ENEMY_SPRITES[boss.templateId as keyof typeof ENEMY_SPRITES]!.idle} size={80} className="scale-x-[-1]" />
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[10px] text-zinc-500 mt-1">L{boss.level} · {boss.hp.toLocaleString()} HP max</div>
          </div>
        </div>
        <div className="mt-3">
